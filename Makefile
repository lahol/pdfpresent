...
CFLAGS=-Wall -g `$(PKG_CONFIG) --cflags poppler poppler-glib glib-2.0 gtk+-3.0 cairo`
LIBS=-lc -lz `$(PKG_CONFIG) --libs poppler poppler-glib glib-2.0 gthread-2.0 gtk+-3.0 cairo`
